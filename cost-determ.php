...
session_start();
    ...
    $cost_determ_query = "select * from broadcasts where trans_cost = 0";
    $cost_determ = mysqli_query($con, $cost_determ_query);
...
<main id="main" style="margin-top: 100px;">
    ...
    <div class="container">
        <div class="portfolio-description">
            <h2 class="mb-5">Cost Determination</h2>
            <div class="row">
                <?php
                    while($row = mysqli_fetch_array($cost_determ)) {
                ?>
